...
- Source shape after this pass: 96 main Kotlin files, 35 JVM test files, 11 instrumented test files.
...
- Completed in this pass: roadmap 1.2.1, 1.2.2, 1.2.3, 1.2.4, 1.3.1, 1.3.2, 1.3.3, 1.3.4, 1.4.4, 1.4.5, 1.5.1, 1.5.2, 1.5.3, 1.5.4, 1.6.1, 1.6.2, and 1.6.3.
...
Roadmap 1.6.4 is next: add `RepositoryModule` bindings for the domain repository interfaces.
