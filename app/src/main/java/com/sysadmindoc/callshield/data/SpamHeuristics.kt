...
class SpamHeuristics
    ...
    constructor() {
        ...
        companion object {
            ...
            fun isWangiriCountryCode(number: String): Boolean = shared.isWangiriCountryCode(number)

            fun isHighSpamVoipRange(number: String): Boolean = shared.isHighSpamVoipRange(number)
            ...
            fun isHotCampaignRange(number: String): Boolean = shared.isHotCampaignRange(number)

            fun isInvalidFormat(number: String): Boolean = shared.isInvalidFormat(number)
