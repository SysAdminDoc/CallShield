 ...
 */
object HttpClient {
    internal val pinnedEndpointPins: Map<String, List<String>> = mapOf(
        ...
        "urlhaus-api.abuse.ch" to listOf(
        ...
        "phonevalidation.abstractapi.com" to listOf(
    ...
    internal val certificatePinner: CertificatePinner = CertificatePinner.Builder().apply {
