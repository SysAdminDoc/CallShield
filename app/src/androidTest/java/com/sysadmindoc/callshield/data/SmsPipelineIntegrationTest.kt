...
class SmsPipelineIntegrationTest {
    ...
    @Test
    fun smsKeywordRulesStillInspectWhitelistedSenders() = runBlocking {
    ...
    @Test
    fun smsContentAnalysisBlocksWhenNoKeywordRuleMatches() = runBlocking {
