...
| 1.5.2 Extract `SpamCheckResult` and settings models to domain layer | S | `[NOW]` | `domain/model/*.kt` |
| 1.5.3 Define repository interfaces in domain | M | `[NEXT]` | `domain/repository/*.kt` |
