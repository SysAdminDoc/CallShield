...
Eight instrumented test files now exist (`CrashReporterInstrumentedTest`, `DashboardStatusBadgeTest`, `ThemePrimitivesTest`, `SpamPipelineIntegrationTest`, `SmsPipelineIntegrationTest`, `SyncIntegrationTest`, `HotListSyncIntegrationTest`, `OnboardingTest`). Remaining:
...
|---|---|---|
| Phase 1 — Foundation | 35 | ~62% done (1.1, 1.2, 1.3.1, 1.4, and 1.7.1-7 shipped; 1.6 and 1.7.8 open) |
