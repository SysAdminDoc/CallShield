...
if ($python) {
    foreach ($test in @('test_phone_normalization.py', 'test_report_dedup.py', 'test_report_pipeline.py', 'test_model_calibration.py', 'test_check_translations.py', 'test_source_registry.py')) {
