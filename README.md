...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-870-94e2d5?style=flat-square" alt="870 Tests">
...
- **870 total JVM unit tests** - the local unit suite covers detection, workers, utilities, repository contracts, and permission readiness before release.
...
```bash
./gradlew testDebugUnitTest   # 870 tests
...
| Tests | 870 JVM unit tests (JUnit) |
