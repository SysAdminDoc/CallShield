...
<p align="center">
  ...
  15+ layer detection + Gradient-Boosted Tree ML | 51,362 spam numbers | Real-time caller ID | RCS filter | No required API keys
</p>
...
1. **51,362 imported spam numbers.** Sources include FCC consumer complaints (2+ reports each), FTC Do Not Call, ToastedSpam, and corroborated community reports.
...
### Database (51,362 numbers + 653 range prefixes, locally maintained)
| Source | Method |
|--------|--------|
...
| Strings | 1665 string resources and 38 plural groups (translation-ready) |
