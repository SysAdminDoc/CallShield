...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-688-94e2d5?style=flat-square" alt="688 Tests">
...
- **688 total JVM unit tests** - the local unit suite covers detection, workers, utilities, repository contracts, and permission readiness before release.
...
```bash
./gradlew testDebugUnitTest   # 688 tests
```
...
| Tests | 688 JVM unit tests (JUnit) |
| Strings | 1012 string resources and 28 plural groups (translation-ready) |
