...
<p align="center">
  ...
  15+ layer detection + Gradient-Boosted Tree ML | 51,360 spam numbers | Real-time caller ID | RCS filter | No required API keys
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Spam%20Numbers-51%2C360-f38ba8?style=flat-square" alt="51,360 Numbers">
...
1. **51,360 imported spam numbers.** Sources include FCC consumer complaints (2+ reports each), FTC Do Not Call, ToastedSpam, and corroborated community reports.
...
|  5200 | **Spam Database** | Block | 51,360 imported spam numbers plus the trending-numbers feed |
...
### Database (51,360 numbers + 653 range prefixes, locally maintained)
| Source | Method |
|--------|--------|
...
| Strings | 1655 string resources and 38 plural groups (translation-ready) |
