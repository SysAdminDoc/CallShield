...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-686-94e2d5?style=flat-square" alt="686 Tests">
...
- **686 total JVM unit tests** - the local unit suite covers detection, workers, utilities, repository contracts, and permission readiness before release.
...
```bash
./gradlew testDebugUnitTest   # 686 tests
```
...
| Tests | 686 JVM unit tests (JUnit) |
| Strings | 997 string resources and 28 plural groups (translation-ready) |
