...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-900-94e2d5?style=flat-square" alt="900 Tests">
...
- **900 total JVM unit tests** - the local unit suite covers detection, workers, utilities, repository contracts, and permission readiness before release.
...
```bash
./gradlew testDebugUnitTest   # 900 tests
...
| Tests | 900 JVM unit tests (JUnit) |
