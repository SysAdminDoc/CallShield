...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-699-94e2d5?style=flat-square" alt="699 Tests">
...
- **699 total JVM unit tests** - the local unit suite covers detection, workers, utilities, repository contracts, and permission readiness before release.
...
```bash
./gradlew testDebugUnitTest   # 699 tests
```
...
| Tests | 699 JVM unit tests (JUnit) |
