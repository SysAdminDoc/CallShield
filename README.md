...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-693-94e2d5?style=flat-square" alt="693 Tests">
...
- **693 total JVM unit tests** - the local unit suite covers detection, workers, utilities, repository contracts, and permission readiness before release.
...
```bash
./gradlew testDebugUnitTest   # 693 tests
```
...
| Tests | 693 JVM unit tests (JUnit) |
